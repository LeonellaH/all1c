...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для каждого ИнфоСообщение Из МассивИнфоСообщений Цикл
			...
			ТекстКартинки = "<p><img src=""data:image/png;base64," + ТекстКартинки + """ hspace=""10"" alt="""" align=""left"">";
			
			ОтображаемаяСтрока = ОтображаемаяСтрока + ТекстКартинки + ИнфоСообщение.ТекстСообщения + "</p>";
